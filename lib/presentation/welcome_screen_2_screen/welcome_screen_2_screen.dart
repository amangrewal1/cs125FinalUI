...
import 'bloc/welcome_screen_2_bloc.dart';

class WelcomeScreen2Screen extends StatelessWidget {
  const WelcomeScreen2Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<WelcomeScreen2Bloc>(
        create: (context) => WelcomeScreen2Bloc(
            WelcomeScreen2State(welcomeScreen2ModelObj: WelcomeScreen2Model()))
          ..add(WelcomeScreen2InitialEvent()),
        child: WelcomeScreen2Screen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<WelcomeScreen2Bloc, WelcomeScreen2State>(
